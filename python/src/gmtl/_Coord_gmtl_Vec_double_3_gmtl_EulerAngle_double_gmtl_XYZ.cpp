...
void _Export_Coord_gmtl_Vec_double_3_gmtl_EulerAngle_double_gmtl_XYZ()
{
    ...
    class_< gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::XYZ> > >("Coord3dXYZ", init<  >())
        ...
        .def("set",
             (gmtl::Coord<gmtl::Vec<double, 3>, gmtl::EulerAngle<double, gmtl::XYZ> >& (gmtl::Coord<gmtl::Vec<double, 3>, gmtl::EulerAngle<double, gmtl::XYZ> >::*)(const gmtl::Coord<gmtl::Vec<double, 3>, gmtl::EulerAngle<double, gmtl::XYZ> >&)) &gmtl::Coord<gmtl::Vec<double, 3>, gmtl::EulerAngle<double, gmtl::XYZ> >::operator=,
