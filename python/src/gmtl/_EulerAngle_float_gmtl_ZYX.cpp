...
void _Export_EulerAngle_float_gmtl_ZYX()
{
    ...
    class_< gmtl::EulerAngle<float,gmtl::ZYX> >("EulerAngleZYXf", init<  >())
        ...
        .def("getData", (tuple (gmtlWrappers::*)(gmtl::EulerAngle<float,gmtl::ZYX>*)) &gmtlWrappers::EulerAngle_getData)
        .add_property("data", (tuple (gmtlWrappers::*)(gmtl::EulerAngle<float,gmtl::ZYX>*)) &gmtlWrappers::EulerAngle_getData)
