...
void _Export_Coord_gmtl_Vec_float_3_gmtl_AxisAngle_float()
{
    ...
    class_< gmtl::Coord<gmtl::Vec<float, 3>,gmtl::AxisAngle<float> > >("Coord3fAxisAngle", init<  >())
        ...
        .def_readwrite("mPos", &gmtl::Coord<gmtl::Vec<float, 3>,gmtl::AxisAngle<float> >::mPos)
        .def_readwrite("mRot", &gmtl::Coord<gmtl::Vec<float, 3>,gmtl::AxisAngle<float> >::mRot)
        ...
        .def("pos", &gmtl::Coord<gmtl::Vec<float, 3>,gmtl::AxisAngle<float> >::pos, return_internal_reference< 1 >())
        .def("rot", &gmtl::Coord<gmtl::Vec<float, 3>,gmtl::AxisAngle<float> >::rot, return_internal_reference< 1 >())
