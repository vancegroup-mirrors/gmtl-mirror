...
void _Export_VecBase_float_4()
{
    ...
    class_< gmtl::VecBase<float,4> >("VecBase4f", init<  >())
        ...
        .def("getData", (tuple (gmtlWrappers::*)(gmtl::VecBase<float,4>*)) &gmtlWrappers::VecBase_4_getData)
        .add_property("data", (tuple (gmtlWrappers::*)(gmtl::VecBase<float,4>*)) &gmtlWrappers::VecBase_4_getData)
