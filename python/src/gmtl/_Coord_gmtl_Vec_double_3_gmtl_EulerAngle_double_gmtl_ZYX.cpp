...
void _Export_Coord_gmtl_Vec_double_3_gmtl_EulerAngle_double_gmtl_ZYX()
{
    ...
    class_< gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::ZYX> > >("Coord3dZYX", init<  >())
        ...
        .def_readwrite("mPos", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::ZYX> >::mPos)
        .def_readwrite("mRot", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::ZYX> >::mRot)
        ...
        .def("pos", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::ZYX> >::pos, return_internal_reference< 1 >())
        .def("rot", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::EulerAngle<double, gmtl::ZYX> >::rot, return_internal_reference< 1 >())
        .def(self == self)
        .def(self != self)
    );
