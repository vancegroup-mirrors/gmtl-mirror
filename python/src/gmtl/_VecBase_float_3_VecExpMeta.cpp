...
void _VecBase_float_3_VecExpMeta()
{
   ...
   scope* gmtl_VecBase_float_3_VecBinaryExpr_ScalarArg_VecMultBinary_scope = new scope(
   ...
   delete gmtl_VecBase_float_3_VecBinaryExpr_ScalarArg_VecMultBinary_scope;
   ...
   scope* gmtl_VecBase_float_3_VecBinaryExpr_ScalarArg_VecDivBinary_scope = new scope(
   ...
   delete gmtl_VecBase_float_3_VecBinaryExpr_ScalarArg_VecDivBinary_scope;
