...
void _Export_VecBase_double_4()
{
    ...
    class_< gmtl::VecBase<double,4> >("VecBase4d", init<  >())
        ...
        .def("getData", (tuple (gmtlWrappers::*)(gmtl::VecBase<double,4>*)) &gmtlWrappers::VecBase_4_getData)
        .add_property("data", (tuple (gmtlWrappers::*)(gmtl::VecBase<double,4>*)) &gmtlWrappers::VecBase_4_getData)
