 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: _Coord_gmtl_Vec_double_3_gmtl_AxisAngle_double.cpp,v $
...
void _Export_Coord_gmtl_Vec_double_3_gmtl_AxisAngle_double()
{
    ...
    class_< gmtl::Coord<gmtl::Vec<double, 3>,gmtl::AxisAngle<double> > >("Coord3dAxisAngle", init<  >())
        ...
        .def_readwrite("mPos", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::AxisAngle<double> >::mPos)
        .def_readwrite("mRot", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::AxisAngle<double> >::mRot)
        ...
        .def("pos", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::AxisAngle<double> >::pos, return_internal_reference< 1 >())
        .def("rot", &gmtl::Coord<gmtl::Vec<double, 3>,gmtl::AxisAngle<double> >::rot, return_internal_reference< 1 >())
