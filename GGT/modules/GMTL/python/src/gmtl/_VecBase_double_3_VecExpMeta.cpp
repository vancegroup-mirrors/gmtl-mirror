 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: _VecBase_double_3_VecExpMeta.cpp,v $
...
{
   typedef gmtl::VecBase<double, 3,
                         gmtl::meta::VecBinaryExpr<gmtl::VecBase<double,3>,
                                                   gmtl::VecBase<double,3>,
                                                   gmtl::meta::VecPlusBinary>
                        > VecBase_VecPlusBinary_t;

   scope* gmtl_VecBase_double_3_VecBinaryExpr_VecPlusBinary_scope = new scope(
   class_<VecBase_VecPlusBinary_t>("VecBase3dPlusBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_VecPlusBinary_scope;
   ...
   scope* gmtl_VecBase_double_3_VecBinaryExpr_VecMinusBinary_scope = new scope(
   class_<VecBase_VecMinusBinary_t>("VecBase3dMinusBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_VecMinusBinary_scope;
   ...
   scope* gmtl_VecBase_double_3_VecBinaryExpr_VecMultBinary_scope = new scope(
   class_<VecBase_VecMultBinary_t>("VecBase3dMultBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_VecMultBinary_scope;
   ...
   scope* gmtl_VecBase_double_3_VecBinaryExpr_VecDivBinary_scope = new scope(
   class_<VecBase_VecDivBinary_t>("VecBase3dDivBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_VecDivBinary_scope;
   ...
   scope* gmtl_VecBase_double_3_VecBinaryExpr_ScalarArg_VecMultBinary_scope = new scope(
   class_<VecBase_ScalarArg_VecMultBinary_t>("VecBase3dScalarArgMultBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_ScalarArg_VecMultBinary_scope;
   ...
   scope* gmtl_VecBase_double_3_VecBinaryExpr_ScalarArg_VecDivBinary_scope = new scope(
   class_<VecBase_ScalarArg_VecDivBinary_t>("VecBase3dScalarArgDivBinary",
   ...
   delete gmtl_VecBase_double_3_VecBinaryExpr_ScalarArg_VecDivBinary_scope;

   typedef gmtl::VecBase<double, 3,
                         gmtl::meta::VecUnaryExpr<gmtl::VecBase<double,3>,
                                                  gmtl::meta::VecNegUnary>
                        > VecBase_VecNegUnary_t;

   scope* gmtl_VecBase_double_3_VecUnaryExpr_VecNegUnary_scope = new scope(
   class_<VecBase_VecNegUnary_t>("VecBase3dNegUnary",
   ...
   delete gmtl_VecBase_double_3_VecUnaryExpr_VecNegUnary_scope;
